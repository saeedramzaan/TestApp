 ...
 /*  position: relative;
   left : 10%; */
      ...
      .redTrans{
          ...
          background:url('image/red.png')  center no-repeat;
...
html {
  scroll-behavior: smooth;
      ...
      <div id="app">
        ...
        <div class="btnSet">
        <a class="navbar-brand" href="{{route('login')}}"><h5 class="btnPos">Shop</h5></a>
   ...
   <div class="navLog">
       ...
       <a class="dropdown-item" href="search?field=Poulet">Poulet</a>
       <a class="dropdown-item" href="search?field=Rind">Rind</a>
            <a class="dropdown-item" href="search?field=Lamm">Lamm</a>
            <a class="dropdown-item" href="search?field=Crevetten">Craventten</a>
            <a class="dropdown-item" href="search?field=Gemuse">Gemüse</a>

            <a class="dropdown-item" href="search?field=Ente">Ente</a>
            <a class="dropdown-item" href="search?field=Fish">Fisch</a>
            <a href="search?field=Instant Food">Convenience</a> 
            
            <a class="dropdown-item" href="search?field=Dry food">Kokos & Öl</a> 
            <a class="dropdown-item" href="search?field=Exotic Kitchen">Diversen</a> 
            <br>
            <a class="dropdown-item" href="search?field=Wild">Wild</a> 
       ...
       <a class="dropdown-item" href="search?field=Rind">Rind</a>
            ...
            <li class="nav-item">
              <a style="text-transform: initial;" class="navbar-brand active" href="#offer">Offers</a>
                          ...
                          <a href="{{ url('/specialCon') }}" class="dropdown-item">
                      ...
                      <a href="{{ url('/reg') }}" class="dropdown-item">
