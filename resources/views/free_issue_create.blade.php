                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <form action="{{ route('update.spe') }}" method="POST" role="form" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group row mb-0 mt-5">
                                            ...
                                            <div class="col-md-4 offset-md-4">
                                                <input type="text" class="form-control" name="txtName" value="{{ $product->pname }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-0 mt-5">
                                            ...
                                            <div class="col-md-4 offset-md-4">
                                                <input type="text" class="form-control" name="txtType" value="{{ $product->category }}" />
                                            </div>
                                        </div>
                                        @endforeach
                                        ...
                                        <div class="form-group row mb-0 mt-5">
                                            ...
                                            <div class="col-md-4 offset-md-4">
                                                <input type="text" class="form-control" name="txtPQty" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-0 mt-5">
                                            ...
                                            <div class="col-md-4 offset-md-4">
                                                <input type="text" class="form-control" name="txtFQty" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-0 mt-5">
                                            ...
                                            <div class="col-md-4 offset-md-4">
                                                <input type="text" class="form-control" name="txtLlimit" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-0 mt-5">
                                            ...
                                            <div class="col-md-4 offset-md-4">
                                                <input type="text" class="form-control" name="txtUlimit" />
                                            </div>
                                        </div>
